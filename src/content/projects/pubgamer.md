...
gallery:
  - src: /img/pubgamer/v1.jpg
    desc: Early PubGamer website design
  - src: /img/pubgamer/v2.jpg
    desc: Later website iteration
  - src: /img/pubgamer/v3.jpg
    desc: Final website iteration
  - src: /img/pubgamer/forum.jpg
    desc: Custom-themed phpBB forum
  - src: /img/pubgamer/mobile site.jpg
    desc: Mobile-friendly community site
  - src: /img/pubgamer/file hosting provider.jpg
    desc: File hosting service for the community
  - src: /img/pubgamer/server hosting.jpg
    desc: Game server hosting website
  - src: /img/pubgamer/server hosting 2.jpg
    desc: Game server hosting and payment flow
  - src: /img/pubgamer/hl2rp server.jpg
    desc: Half-Life 2 roleplay server
  - src: /img/pubgamer/ttt server.jpg
    desc: Trouble in Terrorist Town server
  - src: /img/pubgamer/main_logo.png
    desc: PubGamer branding and logo work
---
